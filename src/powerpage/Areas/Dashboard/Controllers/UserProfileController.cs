...
using powerpage.Common.GuardToolkit;
...
[Authorize, Area(AreaConstants.DashboardArea), BreadCrumb(Title = "مشخصات کاربری", UseDefaultRouteUrl = true, Order = 0)]
        ...
        if (ModelState.IsValid)
        {
            ...
            if (updateResult.Succeeded)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    "~/Areas/Dashboard/Views/EmailTemplates/_UserProfileUpdateNotification.cshtml",
